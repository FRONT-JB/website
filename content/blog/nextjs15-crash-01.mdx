...
<Callout>Next.js에서는 동적 라우트를 손쉽게 설정할 수 있어요.</Callout>
...
<Callout type="Callout" title="예시 URL">
...
<Callout>`[...id]`를 사용하면 여러 개의 값을 배열로 받을 수 있어요.</Callout>
...
<Callout>
  라우트를 그룹으로 묶어서 관리하고 싶다면 `()`를 사용하면 돼요!
</Callout>
